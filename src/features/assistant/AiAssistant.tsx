...
import { streamAssistantReply } from './api';
import { DEFAULT_ASSISTANT_CONFIG, ASSISTANT_STORAGE_KEY } from './config';
import { buildKB, retrieve, buildSystemPrompt, fallbackReply } from './knowledgeBase';
import type { AssistantApiConfig as ApiCfg, AssistantMessage as Msg } from './types';

// ── 类型 ──────────────────────────────────────────────────
const STORAGE_KEY = ASSISTANT_STORAGE_KEY;
const DEFAULT_CFG = DEFAULT_ASSISTANT_CONFIG;
const SUGGESTIONS = [
  'Bob 是谁？有什么背景？',
  '介绍一下他的项目经历',
  '获得过哪些奖项？',
